          ...
          >
            ...
            <div className="flex justify-end space-x-4">
              <a
                ...
                className="rounded-md bg-gradient-to-r from-gray-600 to-blue-500 px-4 py-2 font-medium text-white hover:from-gray-700 hover:to-blue-600 transition-all duration-200"
              >
